...
const vagas: VagaType[] = [
  ...
  },
  {
    ...
    descricao: 'Liderança técnica em arquiteturas de microsserviços e alta disponibilidade.',
    nivel: 'Senior',
  ...
  return (
    <ListaSection>
      <ListaHeader>
        ...
        <ListaEtapa>{vagasFiltradas.length} vaga(s) encontrada(s)</ListaEtapa>
      </ListaHeader>
      <ListaGrid>
